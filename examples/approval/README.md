...
This is a demonstration of Inspect's [Approval Mode](https://inspect.ai-security-institute.uk/approval.html) whereby tool calls are approved by a combination of approvers and approval policies.
...
See the documentation on [Approval Mode](https://inspect.ai-security-institute.uk/approval.html) for additional information on using approvals and defining custom approvers.
